...
const About = ({}) => {
    return(
        <Layout>
            <div>
                <p>En veterinaria Veterina, entendemos que tu mascota no es solo un animal de compañía, sino un miembro querido de tu familia.
                Por eso, nuestra misión es ofrecer un cuidado excepcional y personalizado a cada uno de nuestros pacientes, asegurando su bienestar y salud.</p>
                <p>
